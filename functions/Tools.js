...
function getFBAdminInstance() {
  if (!admin.apps.length) {
    admin.initializeApp({
      serviceAccountId: functions.config().configfb.client_email,
      storageBucket: functions.config().configfb.storage_bucket,
      projectId: functions.config().configfb.database_name
    });
...
function getAccessToken() {
  ...
  var key = functions.config().configfb;
  return new Promise((resolve, reject) => {
    const client_email = key.client_email;
    const private_key = String(key.private_key).replace(/\\n/g, '\n');
    var jwtClient = new google.auth.JWT(client_email, null, private_key, SCOPES, null);
...
async function sendEmail(body) {
  ...
  `;
    ...
    if (body.templateId) {
      ...
      finalData = {
        url: functions.config().mailing.url,
        json: true,
        method: 'POST',
        headers: {
          'content-type': 'application/json',
          accept: 'application/json',
          'api-key': functions.config().mailing.apikey
        },
        data: sendData2
      };
    } else {
...
async function sendNotificationHandler(tokens, title, body, priority, type, data, device, uid) {
  ...
  const LINK_WEB = functions.config().configapp.url + '/notifications/' + type + '/' + base64;
  ...
  let payload = {
    message: {
      ...
      notification: {
        title: title,
        body: body,
        image: functions.config().configapp.icon
      },
      android: {
        notification: {
          title: title,
  ...
  try {
    ...
    const URL = functions.config().cloud_messaging.url;
...
module.exports.arraySearch = arraySearch;
module.exports.stringSearch = stringSearch;
module.exports.excerpt = excerpt;
module.exports.slugify = slugify;
module.exports.parserJSON = parserJSON;
module.exports.parser = parser;
module.exports.getSpecialty = getSpecialty;
module.exports.getSpecialties = getSpecialties;
module.exports.arrayPaginator = arrayPaginator;
module.exports.cleanString = cleanString;
module.exports.searchArrayHandler = searchArrayHandler;
module.exports.unique = unique;
module.exports.getFBAdminInstance = getFBAdminInstance;
module.exports.asyncForEach = asyncForEach;
module.exports.sendEmail = sendEmail;
module.exports.sendRequest = sendRequest;
module.exports.sendNotificationHandler = sendNotificationHandler;
module.exports.notificationList = notificationList;
